        ...
        <div className="flex flex-col items-center border-t pt-6">
          <nav className="mb-4 flex flex-wrap justify-center gap-x-4 gap-y-2 md:justify-start md:gap-6">
            {navLinks.map((item) => (
              <Link
                to={item.path}
                key={item.id}
                className="text-gray-500 transition duration-100 hover:text-first active:text-first"
              >
                {item.value}
              </Link>
            ))}
          ...
          <div className="flex gap-4">
            <a
              href="#"
              target="_blank"
              className="text-gray-400 transition duration-100 hover:text-first active:text-gray-600"
            >
              <svg
                className="h-5 w-5"
                width="24"
