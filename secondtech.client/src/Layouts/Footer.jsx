        ...
        <div className="grid grid-cols-4 gap-8">
          <div className="flex flex-col gap-4">
            <ul className="flex flex-col items-center">
              ...
              {socialMediaList.map((item) => (
                <li key={item.name} className="mb-4">
                  <a href={item.link} className="flex items-center gap-2 hover:text-white">
                    {item.icon}
                    {item.name}
                  </a>
                </li>
            ...
            <ul className="flex flex-col gap-4">
              <h2 className="text-white text-xl font-medium mb-2">Категории</h2>
              <li>
                <Link to="/smartphone" className="text-gray-400 hover:text-white">
                  Телефоны
                </Link>
              </li>
              <li>
                <Link to="/laptop" className="text-gray-400 hover:text-white">
                  Ноутбуки
                </Link>
              </li>
            </ul>
            <ul className="flex flex-col gap-4">
              {' '}
              {/* Buyer list */}
              <h2 className="text-white text-xl font-medium mb-2">Покупателям</h2>{' '}
              {/* Buyer heading */}
              {forBuyers.map((item) => (
                <li key={item.title} className="mb-2">
                  <Link to={item.link} className="text-gray-400 hover:text-white">
                    {item.title}
                  </Link>
                </li>
              ))}
            ...
            <ul className="flex flex-col gap-4">
              {' '}
              {/* Contact information */}
              <li className="text-white text-xl font-medium mb-2">+996(500) 968 094</li>
              <li>
            ...
            <div className="flex items-center gap-4">
              <Link>
                <p className="text-gray-400 hover:text-white">
                  © 2024 SecondTech Все права защищены
                </p>
              </Link>
              <Link>
                <p className="text-gray-400 hover:text-white">Политика конфиденциальности</p>
              </Link>
            </div>
          </div>
        </div>
